/**
 * Import search dictionary from data/search-dictionary.json into the DB.
 * Run: npx tsx scripts/import-search-dictionary.ts
 * File is generated by: npx tsx scripts/generate-search-dictionary.ts
 */
