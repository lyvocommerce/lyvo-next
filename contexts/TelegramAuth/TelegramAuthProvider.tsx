...
import { TelegramAuthContext, TelegramAuthProviderProps } from './TelegramAuthContext'
import { MOCK_TELEGRAM_USER, applyDefaultTelegramTheme, TEST_MODE_CONFIG } from '@/mocks/telegram-test-data'
...
export default function TelegramAuthProvider({ children, testMode: testModeProp }: TelegramAuthProviderProps) {
  ...
  const urlTestMode = typeof window !== 'undefined' && window.location.search.includes('testMode=true')
